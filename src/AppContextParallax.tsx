...
import {
  HandleScroll,
  IAppContextParallax,
  IAppProviderParallax,
} from "./interfaces";

export const AppContext = createContext<IAppContextParallax>(
  {} as IAppContextParallax
);

export const AppProviderParallax: React.FC<IAppProviderParallax> = ({
  children,
  speed,
  start,
  end,
